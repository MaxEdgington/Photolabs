...
const PhotoDetailsModal = (props) => {
  ...
  return (
    <div className="photo-details-modal">
      {console.log("PhotoModalProps", props)}
      <button className="photo-details-modal__close-button" onClick={exit}>
        <img src={closeSymbol} alt="close symbol" />
      </button>

      <div>
        <PhotoFavButton onClick={() => props.toggleLikedPhotos(props.selectedPhoto.id)} selected={selected} />

        <img className="photo-details-modal__image" src={props.selectedPhoto.urls.regular} alt="Description of the image" />

        <div className="photo-details-modal__photographer-details">
          <img className="photo-details-modal__photographer-profile " src={props.selectedPhoto.user.profile} alt="Description of the image" />
          <div className="photo-details-modal__photographer-info">
            <span>{props.selectedPhoto.user.username}</span><br />
