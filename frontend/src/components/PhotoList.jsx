...
const PhotoList = (props) => {
  ...
  const renderedPhotos = props.photos.map((item, i) => {
    return <PhotoListItem setShowModal={props.setShowModal} selectedPhoto={props.selectedPhoto}
      setSelectedPhoto={props.setSelectedPhoto} // now we know photolist item will have access to setSelectedPhoto
      className="photo-list__item" key={item.id} toggleLikedPhotos={props.toggleLikedPhotos} likedPhotos={props.likedPhotos} photoList={props.PhotoList} item={item} />;
  });
